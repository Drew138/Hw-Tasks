...
public class EjercicioEstrella {
    ...
    String rutaJumbo =
    "https://www.tiendasjumbo.co/tecnologia/televisores-y-video/proyectores";
    ...
    .indexOf("<span
    class=\"product-prices__valueproduct-prices__value--best-price\">") + 70;
    ...
    System.out.println("Nombre: " + nombre + ", marca: " + marca + ", Precio: " +
    precio);
    }
    reader.close();
